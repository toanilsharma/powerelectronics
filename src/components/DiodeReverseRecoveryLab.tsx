    ...
    <div className="bg-[#0b101b] border border-[#1e293b] rounded-2xl p-4 text-slate-200 shadow-2xl space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between border-b border-[#1e293b] pb-3 gap-2">
        ...
        <div className="flex items-center gap-2 bg-[#0f172a] p-1.5 rounded-xl border border-[#334155]">
          ...
          <span className="text-xs font-mono text-cyan-400 font-bold">SPEED:</span>
          {[
            { label: '1x', val: 1.0 },
            { label: '0.1x', val: 0.1 },
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-mono font-bold transition-all cursor-pointer min-h-[30px] ${
                timeDilation === spd.val
                  ? 'bg-cyan-500 text-slate-950 font-black shadow-md shadow-cyan-500/50 border border-white scale-105'
