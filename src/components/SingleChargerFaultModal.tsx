...
const FAULT_DEFINITIONS: FaultDefinition[] = [
  ...
  {
    key: 'groundFaultPos',
    title: 'Positive Rail (+VE) Earth Fault (Ungrounded DC System)',
    code: 'F-DC-64P',
    category: 'DC / Filter',
    description: 'Insulation breakdown or ground fault on Positive DC Rail in ungrounded floating system.',
    impact: 'V_L+ collapses to 0V while V_L- shifts to -110V (or -220V). ANSI 64 / 89G Earth Relay triggers alarm; load remains live.',
  },
  {
    key: 'groundFaultNeg',
    title: 'Negative Rail (-VE) Earth Fault (Ungrounded DC System)',
    code: 'F-DC-64N',
    category: 'DC / Filter',
    description: 'Insulation breakdown or ground fault on Negative DC Rail in ungrounded floating system.',
    impact: 'V_L- collapses to 0V while V_L+ shifts to +110V (or +220V). ANSI 64 / 89G Earth Relay triggers alarm; load remains live.',
  },
  {
    key: 'groundFault',
    title: 'DC Bus General Insulation Breakdown',
    code: 'F-DC-64',
    category: 'DC / Filter',
